...
<div class="container mx-auto mt-0 space-y-4 px-4 py-10 md:max-w-5xl">
	...
	<ul class="space-y-4">
		{#each surveys as survey}
			<li class="card flex flex-col gap-4 p-2 md:flex-row">
				<div class="flex h-32 w-[10rem] items-stretch gap-2">
					<img class="h-fit w-[50%]" src="/surveyPhotos/{survey.exteriorPhoto}" alt="" />
					<img class="h-fit w-[50%]" src="/surveyPhotos/{survey.centerMarkPhoto}" alt="" />
				</div>
				<span class="d-none md:divider-vertical" />
				<div class="grow">
					<div class="flex flex-col justify-between gap-0.5 md:flex-row md:gap-4">
